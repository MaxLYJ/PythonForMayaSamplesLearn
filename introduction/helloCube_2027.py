...
# Maya 2027 uses Python 3, where print is a function so the text must be in parentheses
print(cube)
...
# In Python 3, type() returns a class object rather than a type, so it looks like <class 'list'>
print(type(cube))
