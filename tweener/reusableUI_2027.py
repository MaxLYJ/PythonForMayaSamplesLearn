# Maya 2027 note: This file is already compatible with Maya 2027 (Python 3, maya.cmds API).
# No code changes were required; this is a verified copy for the 2027 versions folder.
# Original teaching file: tweener/reusableUI.py
# Note: it imports `tweener` and `gearCreator.gears2`, which are themselves 2027-compatible
#       (see tweener_2027.py / gears2_2027.py). Keep this file's folder on sys.path when running.
